...
class Ftp
{
     ...
     * 检测上传根目录
     *
     * @param string $rootpath 根目录：./Uploads/tempImg/test/
     *
     ...
     * 检测上传目录
     *
     * @param  string $savepath 上传目录：20181218/
     *
    ...
    public function save($file, $replace = true)
    {
        ...
        /* 移动文件 */
        $boolen = ftp_put($this->link, $filename, $file['tmp_name'], FTP_BINARY);
        if (!$boolen) {
            $this->error = '文件上传保存错误！';
     ...
     * 创建目录
     *
     * @param  string $savepath 要创建的目录：20181218/
     *
    ...
    {
        Cache::set('get_ftp_info', $this->error);//设置缓存信息
